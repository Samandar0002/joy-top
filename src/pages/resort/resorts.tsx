...
const Resort: React.FC = () => {
  const [data, setData] = useState<IEntity.ResortsRes[]>();
  ...
  const [payload, setPayload] = useState<IApi.Resort.Request>({});
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const { data } = await Api.ResortList(size, payload);
  ...
  return (
    <>
      <div className="container mx-auto">
        ...
        <h1 className="font-large ml-15 mx-auto my-10 w-[1240px] text-[26px] font-[500]">{t('Oromgohlar')}</h1>
        {
                    ...
                    <div className="card relative m-1">
                      ...
                      <div className="card-info flex flex-col gap-2">
                        ...
                        <p className="card-price text-sm">
                          Days of the week: <span>{item.price}-UZS</span>
                        </p>
